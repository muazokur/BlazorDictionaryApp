...
namespace BlazorDictionary.Api.Application.Features.Commands.EntryComment.DeleteVote
{
    public class DeleteEntryCommentVoteCommandHandler : IRequestHandler<DeleteEntryCommentVoteCommand, bool>
    {
        ...
        {
            QueueFactory.SendMessageToExchange(exchangeName: DictionaryConstants.FavExcahangeName, exchangeType: DictionaryConstants.DefaultExchangeType, queueName: DictionaryConstants.DeleteEntryCommentVoteQueueName, obj: new DeleteEntryCommentVoteEvent() 
            {
